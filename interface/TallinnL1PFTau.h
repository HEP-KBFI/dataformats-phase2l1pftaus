#ifndef TallinnL1PFTau_H
#define TallinnL1PFTau_H
...
namespace l1t {
  ...
  public:
    ...
    //TallinnL1PFTau(const TallinnL1PFTau &input){  
    //setEt( input.et() );
    ...
    friend std::ostream& operator << (std::ostream& os, const l1t::TallinnL1PFTau& reg);
